  ...
  <div class="container mt-4">
    ...
    <div class="section-card">
      ...
      <div class="section-body">
        <p>Matter is anything that takes up space and has mass (weight).</p>
        <img src="../images/matter.png" alt="Matter">
        <ul>
          <li>Everything around us is matter</li>
          <li>Matter can be in different states</li>
          <li>Matter can change from one state to another</li>
        </ul>
      </div>
    </div>
